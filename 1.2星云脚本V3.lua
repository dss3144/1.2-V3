...
local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/longshulol/long/main/longshu/Ohio"))()
local Window = OrionLib:MakeWindow({Name = "星云脚本", HidePremium = false, IntroText = "星云脚本"})
game:GetService("StarterGui"):SetCore("SendNotification",{ Title = "星云脚本"; Text ="欢迎使用星云脚本"; Duration = 4; })
local Tab = Window:MakeTab({
    Name = "关于",
	Icon = "rbxassetid://16385658023",
	PremiumOnly = false
})
Tab:AddParagraph("作者dss","")
...
Tab:AddParagraph("更新20个游戏","")
Tab:AddParagraph("一共支持80多种游戏","")
